...
export class AuthService {
  ...
  async recoverPassword(email: string): Promise<{ success: boolean }> {
    ...
    const message = `Olá! Você solicitou a recuperação de senha. Para alterar sua senha, clique no link a seguir: ${process.env.APP_URL}/change-password?token=${token}`;
